...
simulation.reporters.append(StateDataReporter(f'output/nanma_openmm_mts_{precision}.log', 1000, step=True, time=True, remainingTime=True, potentialEnergy=True, temperature=True, totalSteps=step, speed=True))
