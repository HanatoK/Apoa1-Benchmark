...
print(MTSList)
# use 2fs timestep
integrator = MTSIntegrator(2*u.femtoseconds, MTSList)
...
simulation.reporters.append(StateDataReporter(f'output/nanma_openmm_nve_mts_{precision}.log', 5000, step=True, time=True, remainingTime=True, potentialEnergy=True, temperature=True, totalSteps=step, speed=True))
