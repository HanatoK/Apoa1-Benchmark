...
simulation.reporters.append(StateDataReporter(f'output/nanma_openmm_nve_{precision}.log', 5000, step=True, time=True, remainingTime=True, potentialEnergy=True, kineticEnergy=True, totalEnergy=True, temperature=True, totalSteps=step, speed=True))
