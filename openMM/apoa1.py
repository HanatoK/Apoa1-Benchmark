...
simulation.reporters.append(StateDataReporter('output/nanma_openmm.log', 1000, step=True, time=True, remainingTime=True, potentialEnergy=True, temperature=True, totalSteps=step, speed=True))
